...
import { useSwapCalculation } from '../hooks/useTokenApi';
...
export const SwapInterface: React.FC = () => {
  ...
  // Use React Query hook for swap calculation
  const {
    data: swapResult,
    isLoading,
    error,
  } = useSwapCalculation(sourceToken, targetToken, usdAmountNumber);
      ...
      <div className="card">
        ...
        <div className="flex justify-center mb-4">
          <button
            ...
            className="p-2 rounded-full border border-gray-300 hover:border-gray-400 bg-white hover:bg-gray-50 transition-colors"
